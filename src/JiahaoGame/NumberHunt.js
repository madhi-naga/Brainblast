  ...
  return (
    <div className="nh-container">
      ...
      <div id="NumberHuntDisplay">
        ...
        <button type="button" id="submit" className="btn btn-outline-dark">Submit</button>
        <br></br>
        ...
        <br></br>
        <br></br>
        <Link to={"/menu"} role="button" id="goMenu" className="btn btn-dark">Leave without Saving</Link>
      </div>
    </div>
  )
