...
function Instructions() {
    return (
      <div>
        ...
        <img id="instImage2" alt ="" src={minesweeper}></img>
        ...
        <img id="instImage" alt ="" src={wordreverse}></img>
        ...
        <img id="instImage" alt ="" src={memorygame}></img>
        ...
        <img id="instImage" alt ="" src={numberhunt}></img>
        ...
        <img id="instImage" alt ="" src={aimtrainer}></img>
